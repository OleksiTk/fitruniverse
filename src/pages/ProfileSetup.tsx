...
const ProfileSetup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Спочатку намагаємось зберегти дані профілю в Firestore
    await handleSubmitAge(formData);

    setIsLoading(false);

    // Після успішного збереження даних, переходимо на іншу сторінку
  ...
  const handleSubmitAge = async () => {
    try {
      // Зберігаємо дані профілю в Firestore за допомогою функції saveUserProfile
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="novice">
                      Novice (running for less than a year)
                    </option>
                    ...
                    {[
                      ...
                      <label key={type} className="flex items-center">
                        <input
                          ...
                          checked={formData.runTypes.includes(
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map(
                      (day) => (
                        <label
                          key={day}
                          className="flex flex-col items-center glass-panel p-2"
                        >
                          <input
                            type="checkbox"
                            name="trainDays"
                            value={day.toLowerCase()}
                            checked={formData.trainDays.includes(
                              day.toLowerCase()
                            )}
                            onChange={handleCheckboxChange}
                            className="sr-only"
                          ...
                          <span
                            className={`text-sm font-medium ${
                              formData.trainDays.includes(day.toLowerCase())
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="pt-4">
                  <p className="text-sm text-gray-500 mb-4">
                    This information helps us calculate your calorie burn and
                  ...
                  <div className="glass-panel p-4 bg-fitness-success bg-opacity-30">
                    ...
                    <p className="text-sm text-gray-700">
                      Complete your profile setup to access all features of the
                      app. You can always update your information later in your
                      profile settings.
                    </p>
                  </div>
                </div>
